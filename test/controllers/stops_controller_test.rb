...
class StopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stop" do
    assert_difference('Stop.count') do
      post stops_url, params: { stop: { address: @stop.address, bus_is: @stop.bus_is, latitude: @stop.latitude, longitude: @stop.longitude } }
    end
  ...
  test "should update stop" do
    patch stop_url(@stop), params: { stop: { address: @stop.address, bus_is: @stop.bus_is, latitude: @stop.latitude, longitude: @stop.longitude } }
